...
module.exports = {
    ...
    doc: function(req,res) {
        res.send({message:'Los campos obligatorios son: name => nombre del destacamento; address => Calle y altura; tipo => Comisaría, Comisaría de la mujer, bomberos, juzgados, destacamento provincial, etc  type => Point; coordenates => primero latitud y luego longitud ej: -34.7233359,-58.3957713, solo separados por una coma, sin espacios'})
    },
